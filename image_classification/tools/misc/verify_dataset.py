...
class DatasetValidator:
    ...
    def __init__(self, dataset_cfg, log_file_path, phase):
        ...
        assert (
            dataset_cfg.data[phase].pipeline[0]["type"] == "LoadImageFromFile"
        ), (
            "This tool is only for dataset "
        ...
        try:
            ...
            with open(self.log_file_path, "a") as f:
                ...
                filepath = os.path.join(
                    item["img_prefix"], item["img_info"]["filename"]
                )
                f.write(filepath + "\n")
...
def print_info(log_file_path):
    ...
    with open(log_file_path, "r") as f:
        ...
        if context == "":
            ...
            print(
                f"{num_file} broken files found, name list save in file:"
                f"{log_file_path}"
            )
    print()
