...
class TestFlow(unittest.TestCase):
    def testCoupling(self):
        ...
        self.assertTrue(
            (logdets + inv_logdets).abs().max() < EPS, "CouplingLayer Det is not zero."
        )
    ...
    def testInv(self):
        ...
        self.assertTrue(
            (logdets + inv_logdets).abs().max() < EPS, "InvMM Det is not zero."
        )
    ...
    def testSigmoid(self):
        ...
        self.assertTrue(
            (logdets + inv_logdets).abs().max() < EPS, "Sigmoid Det is not zero."
        )
    ...
    def testActNorm(self):
        ...
        self.assertTrue(
            (logdets + inv_logdets).abs().max() < EPS, "ActNorm Det is not zero."
        )
        ...
        self.assertTrue(
            (logdets + inv_logdets).abs().max() < EPS,
            "ActNorm Det is not zero for the second run.",
        )
        self.assertTrue(
            (x - z).abs().max() < EPS, "ActNorm is wrong for the second run."
        )
    ...
    def testBatchNorm(self):
        ...
        self.assertTrue(
            (logdets + inv_logdets).abs().max() < EPS, "BatchNorm Det is not zero."
        )
        ...
        self.assertTrue(
            (x - z).abs().max() < EPS, "BatchNorm is wrong for the second run."
        )
        ...
        self.assertTrue((x - z).abs().max() < EPS, "BatchNorm is wrong in eval.")
    ...
    def testSequential(self):
        ...
        self.assertTrue(
            (logdets + inv_logdets).abs().max() < EPS, "Sequential Det is not zero."
        )
        ...
        self.assertTrue(
            (x - z).abs().max() < EPS, "Sequential is wrong for the second run."
        )
    ...
    def testSequentialBN(self):
        ...
        self.assertTrue(
            (logdets + inv_logdets).abs().max() < EPS, "Sequential BN Det is not zero."
        )
        ...
        self.assertTrue(
            (x - z).abs().max() < EPS, "Sequential BN is wrong for the second run."
        )
        ...
        self.assertTrue(
            (x - z).abs().max() < EPS, "Sequential BN is wrong for the eval run."
        )
